...
export default async function RavenResume() {
        ...
        <section className={css.jobs} aria-labelledby="experience-heading">
          ...
          <article className={css.job}>
            ...
            <ul className={css.accomplishments}>
              ...
              <li>Transformed dense concept sketches into a production Next.js app that researchers could self-onboard</li>
              <li>Mentored junior engineer from requiring step-by-step direction to autonomous feature ownership</li>
              <li>Engineered custom interactive PDF renderer for displaying and annotating AI-parsed academic papers</li>
              <li>Designed and animated hero sequence demonstrating peer review automation workflow using SVG and GSAP.</li>
          ...
          <article className={css.job}>
            <header>
              ...
              <p className={css.tenure}>
                <span className={css.company}>Westland Real Estate Group · Remote</span>
              </p>
            </header>
            <ul className={css.accomplishments}>
              <li>Redesigned vacancy displays to stop exposing which apartments were empty; $72k/year loss prevention</li>
              <li>Trained junior developers on prompt engineering and AI-assisted workflows (Claude, ChatGPT, Continue)</li>
              <li>Inherited nonfunctional React.js accounting app; rebuilt and migrated across incompatible backend platforms</li>
            </ul>
          </article>
          ...
          <article className={css.job}>
            ...
            <ul className={css.accomplishments}>
              ...
              <li>Redesigned marketplace from stock WordPress into a premium audiophile storefront; 40% increase in sessions</li>
              ...
              <li>Rewrote analytics SaaS pipeline with full test coverage; error tickets dropped 90%, enabling 10x revenue growth</li>
          ...
          <article className={css.job}>
            <header>
              ...
              <p className={css.tenure}>
                <span className={css.company}>Multnomah ESD · ON Semiconductor</span>
              </p>
            </header>
            <ul className={css.accomplishments}>
              {/*<li>Decreased app loading times by 90% by implementing SQL request caching</li> */}
              <li>Reduced app load times from minutes to seconds by implementing SQL request caching on unindexed datasets</li>
              <li>Built purchase-order validation to prevent duplicate orders on high-cost fab parts; ~$80k savings</li>
            </ul>
          </article>
        </section>
