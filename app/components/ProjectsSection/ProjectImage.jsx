...
/**
 * Creates the border-draw-then-fade animation timeline.
 *
...
function createAnimation(target) {
  ...
  const image = target.querySelector(".projectImage");
  ...
  //Image fades in from sepia, starting at 90% of border animation
...
export default function ProjectImage({ alt, base }) {
  return <ScrollTriggeredAnimation animation={createAnimation}>
